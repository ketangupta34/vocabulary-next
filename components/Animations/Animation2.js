    ...
    >
      <div className="h-2/3 w-2/3 text-white flex justify-between flex-col">
        <div>
          ...
          >
            Ditch the flash cards and stop memorizing definitions. Vocabulated
            teaches you words by systematically exposing you to a wide array of
        ...
        <div className="flex justify-end">
          <button
            ...
            onClick={changePage}
            className={
              'float-right border-3 border-white hover:bg-white hover:text-black rounded-xl text-3xl focus:outline-none font-bold py-2 w-40 transition-all duration-200 delay-500 ' +
